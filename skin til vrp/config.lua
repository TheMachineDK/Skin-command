...
menu_options = {
   ...
   -- {name = "Face", f = overlays, param = nil},
    ...
    -- {name = "Kvinde modeller", f = listModels, param = female_models},
   ...
   -- {name = "Multiplayer models", f = listModels, param = mp_models},
    --{name = "Mand/Dame", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {name="Tøj & Sko", id=73, x=72.2545394897461, y=-1399.10229492188, z=29.3761386871338},
    {name="Tøj & Sko", id=73, x=429.21279907227, y=-800.06823730469, z=29.491147994995},
    {name="Tøj & Sko", id=73, x=1190.4973144531, y=2713.4819335938, z=38.222595214844},
    {name="Tøj & Sko", id=73, x=11.419795036316, y=6514.1987304688, z=31.877853393555},
    {name="Tøj & Sko", id=73, x=121.14572906494, y=-225.87477111816, z=54.55782699585},
    {name="Tøj & Sko", id=73, x=-710.80346679688, y=-155.4896697998, z=37.415180206299},  
    {name="Tøj & Sko", id=73, x=-167.863,  y=-298.969,  z=39.733},
    {name="Tøj & Sko", id=73, x=-829.413,  y=-1073.710, z=11.328},
    {name="Tøj & Sko", id=73, x=-1447.797, y=-242.461,  z=49.820},
    {name="Tøj & Sko", id=73, x=1696.291,  y=4829.312,  z=42.063},
    {name="Tøj & Sko", id=73, x=618.093,   y=2759.629,  z=42.088},
    {name="Tøj & Sko", id=73, x=-1193.429, y=-772.262,  z=17.324},
    {name="Tøj & Sko", id=73, x=-3172.496, y=1048.133,  z=20.863},
    {name="Tøj & Sko", id=73, x=-1108.441, y=2708.923,  z=19.107},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(23, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.9001, 1.9001, 0.5001, 1555, 0, 0,165, 0, 0, 0,0)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Tryk ~INPUT_CONTEXT~ for at skifte tøj.")
                    end
                    incircle = true

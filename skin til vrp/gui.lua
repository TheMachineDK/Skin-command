...
--==============================================================================================--
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
GUI.maxVisOptions = 100 ------------------------ Max options to show on the menu                 --
GUI.titleText = {255, 230, 234, 255, 1} ------- Color of title text                             --   
GUI.titleRect = {255, 25, 25, 255} ------------- Color of rectangle [title]                      --
GUI.optionText = {255, 230, 234, 255, 6} ------ Color of option text                            --
GUI.optionRect = {40, 40, 40, 190} ------------ Color of option rectangles                      --
GUI.scroller = {255, 25, 25, 255} ----------- Color of active option                            --
...
menuYModify = 0.500 -------------------- Default: 0.1174   ------ Top bar                      --
